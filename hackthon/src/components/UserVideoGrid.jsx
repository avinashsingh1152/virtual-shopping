 ...
 * ============================================
 * This component uses the VIDEO CALL socket for WebRTC video/audio
 * It is COMPLETELY SEPARATE from the player socket in VirtualMall.jsx
 * 
 * Video Call Socket: http://localhost:3000/meeting (this component)
    ...
    async function connect() {
      try {
        ...
        if (roomsData.success && roomsData.rooms && roomsData.rooms.length > 0) {
          ...
          console.log('🟢 UserVideoGrid: Video Call Socket Connecting (for video/audio)')
