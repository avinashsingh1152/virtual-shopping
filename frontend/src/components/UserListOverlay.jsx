...
export function UserListOverlay() {
  ...
  // Show only if connected or connecting
  if (state.connectionStatus === 'disconnected') {
    return null
  }

  // Combine local user with remote users for display
  const allUsers = [
    {
      userId: 'local',
      userName: 'Me (You)',
      isMuted: false, // You'd need to track this from local state if possible, or leave generic
      isVideoOff: false,
      role: 'me'
    },
    ...state.users
